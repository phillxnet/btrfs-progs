 ...
 * user can use it too (in that case @top must be zero). Also from kernel >=4.18,
 * if @top is zero, the specified path can be non-subvolume directory and
 * subvolumes which cannot be accessed will be skipped (either due to
